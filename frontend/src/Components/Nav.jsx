...
import { checkStatus, userLogout } from "./Redux/auth/auth.login";
...
const Nav = () => {
  ...
  // Handle the case where `state` is null or undefined
  const isLoggedIn = state?.loggedIn || false; // Default to false if `state` is null
  const user = state?.user || null; // Default to null if `state` is null
  return (
    <div>
      <div className="bg-gray-900">
        <div className="px-4 py-6 mx-auto lg:py-8 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="relative flex items-center justify-between lg:justify-center lg:space-x-16">
            ...
            >
            <ShoppingCart color="#ffffff" className=""/>
